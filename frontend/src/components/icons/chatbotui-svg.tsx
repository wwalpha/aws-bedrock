...
interface ChatbotUISVGProps {
  // Theme is derived from CSS (dark mode class). Prop retained for compat but unused.
  theme?: 'dark' | 'light';
  scale?: number;
}
...
export const ChatbotUISVG: FC<ChatbotUISVGProps> = ({ scale = 1 }) => {
  return (
    <svg width={189 * scale} height={194 * scale} viewBox="0 0 189 194" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect
        x="12.5"
        y="12.5"
        width="164"
