      ...
      {selectedChat && (
        <>
          {/* <WithTooltip
            ...
            display={
              <div>
                ...
                <div className="mx-auto mt-2 max-w-xs space-y-2 sm:max-w-sm md:max-w-md lg:max-w-lg">
                  ...
                  <div>Profile Context: {selectedChat.include_profile_context ? 'Enabled' : 'Disabled'}</div>
                  <div> Workspace Instructions: {selectedChat.include_workspace_instructions ? 'Enabled' : 'Disabled'}</div>
            ...
            trigger={
              <div className="mt-1">
                <IconInfoCircle className="cursor-default hover:opacity-50" size={24} />
              </div>
            }
          /> */}
          ...
          {/* <WithTooltip
            ...
            trigger={
              <div className="mt-1">
                <IconMessagePlus className="cursor-pointer hover:opacity-50" size={24} onClick={handleNewChat} />
              </div>
            }
          /> */}
        </>
