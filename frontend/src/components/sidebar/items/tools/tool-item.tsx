...
export const ToolItem: FC<ToolItemProps> = ({ tool }) => {
  ...
  const [customHeaders, setCustomHeaders] = useState(tool.custom_headers as string);
      ...
      renderInputs={() => (
        <>
          <div className="space-y-1">
            ...
            <Input placeholder="Tool name..." value={name} onChange={e => setName(e.target.value)} maxLength={TOOL_NAME_MAX} />
          </div>

          <div className="space-y-1">
            <Label>Description</Label>

            <Input placeholder="Tool description..." value={description} onChange={e => setDescription(e.target.value)} maxLength={TOOL_DESCRIPTION_MAX} />
          </div>
          ...
          <div className="space-y-1">
            ...
            {/* <TextareaAutosize placeholder={`{"X-api-key": "1234567890"}`} value={customHeaders} onValueChange={setCustomHeaders} minRows={1} /> */}
          </div>
