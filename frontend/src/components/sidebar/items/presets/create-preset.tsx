...
export const CreatePreset: FC<CreatePresetProps> = ({ isOpen, onOpenChange }) => {
      ...
      renderInputs={() => (
        <>
          <div className="space-y-1">
            ...
            <Input placeholder="Preset name..." value={name} onChange={e => setName(e.target.value)} maxLength={PRESET_NAME_MAX} />
          </div>

          {/* <ChatSettingsForm chatSettings={presetChatSettings as any} onChangeChatSettings={setPresetChatSettings} useAdvancedDropdown={true} /> */}
        </>
      )}
    />
  );
